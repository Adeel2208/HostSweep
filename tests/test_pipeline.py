"""Basic smoke tests for HostSweep modules"""
import sys
import os
import pytest
...
def test_database_manager_version_roundtrip(tmp_path):
    ...
    assert "hostsweep_version" in versions["standard"]
